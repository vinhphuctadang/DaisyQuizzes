...
INSERT INTO `daisy_question` (`id`, `body`, `choice_a`, `choice_b`, `choice_c`, `collection_id`, `choice_d`, `created_at`) VALUES
	(1, 'Tôi tên gì?', 'Tạ Đặng Vĩnh Phúc', 'Tạ Vĩnh Phúc', 'Đặng Vĩnh Phúc', 2, 'Tạ Phúc', '2019-09-25 22:07:54'),
	(2, 'Mặt trời mọc ở hướng nào?', 'Đông', 'Tây', 'Nam', 2, 'Bắc', '2019-09-26 10:38:24'),
	(4, 'Thủ đô Việt Nam là', 'Hà Nội', 'Cần Thơ', 'Đà Nẵng', 2, 'TP Hồ Chí Minh', '2019-09-26 12:48:43'),
	(5, '1 + 2 x 0 + 3 = ?', '4', '5', '3', 2, '1', '2019-09-26 12:49:44'),
	(6, 'Một ngày bao nhiêu giờ?', '24', '48', '8', 2, '16', '2019-09-28 14:34:12'),
	(7, 'I love you có nghĩa là gì', 'Tôi yêu bạn', 'Bạn yêu tôi', 'Chẳng ai yêu ai', 2, 'Kệ nó', '2019-09-28 14:34:53'),
	(8, 'EQ là gì', 'Emotional Quality', 'E-commerce Quality', 'Encode Quality', 2, 'Emergency Quirk', '2019-09-28 14:36:09');
...
CREATE TABLE IF NOT EXISTS `daisy_round_collection` (
  ...
  `admin_id` int(11) DEFAULT NULL COMMENT 'Admin đã tạo collection này',
  `question_no` int(11) DEFAULT NULL COMMENT 'Số thứ tự câu hỏi hiện tại',
  `access_token` varchar(32) DEFAULT 'has923$$uva_2931_2-2192' COMMENT 'Hiện tại m chưa liên quan đến này',
